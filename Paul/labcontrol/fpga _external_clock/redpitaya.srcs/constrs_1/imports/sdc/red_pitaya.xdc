...
### SATA connector
#rx, tx out, in
set_property IOSTANDARD LVCMOS18 [get_ports {daisy_p_o[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {daisy_n_o[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {daisy_p_i[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports {daisy_n_i[0]}]
#clk out, in
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports {daisy_p_o[1]}]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports {daisy_n_o[1]}]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports {daisy_p_i[1]}]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports {daisy_n_i[1]}]
...
create_clock -period 50.000 -name sata_clk_in [get_ports daisy_p_i[1]]

create_generated_clock -name adc_clk -source [get_ports daisy_p_i[1]] -multiply_by 50 -divide_by 8 [get_pins pll/pll/CLKOUT0]
